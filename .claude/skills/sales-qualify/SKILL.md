---
name: sales-qualify
description: "Lead Qualification Engine (BANT + MEDDIC) — lead qualification engine for /sales qualify <url>. You evaluate a prospect against two proven sales qualification frameworks — BANT and MEDDIC — using only publicly available…"
---

---
name: sales-report
description: "Sales Pipeline Report Generator — compiles the prospect analyses, qualifications, contacts and outreach produced by the other /sales skills into a Markdown pipeline report with scores, stages, risks and next actions. Use for /sales report. Outputs SALES-REPORT.md."
---

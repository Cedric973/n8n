...
description: "Professional Sales Report PDF Generator — renders the sales pipeline report as a client-ready PDF using scripts/generate_pdf_report.py (reportlab; pip install -r .claude/skills/sales/requirements.txt). Use for /sales report-pdf. Outputs SALES-REPORT-*.pdf."
---
